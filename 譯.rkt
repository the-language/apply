...
(定 (^^入 局態內 局態 態 參 句集 續) (續 局態 態 '() `(lambda ,參 ,@句集))) ; (入 (局態 態 句集 式)
;---
; 這裏手動CPS比values簡單
                            ...
                            (入 (局態-址 局態-境 局態 態-塊集 態 句集甲 式)
                               (^^定
                                ...
                                (入 (局態 態 句集乙)
                                   (譯尾始
                                    局態-址 局態-境 局態 態-塊集 態 (尾 集)
                                    (入 (局態-址 局態-境 局態 態-塊集 態 句集丙)
                                       (續 局態-址 局態-境 局態 態-塊集 態 (連 句集甲 句集乙 句集丙))))))))))))]
                [_ (譯
                    局態-址 局態-境 局態 態-塊集 態 (首 集)
                    (入 (局態-址 局態-境 局態 態-塊集 態 句集甲 式)
                       (若 (等？ ^無 式)
...
(定 (譯始 局態-址 局態-境 局態 態-塊集 態 式尾 續) ; (續 局態-址 局態-境 局態 態-塊集 態 句集 式)
   (若 (空？ (尾 集))
          ...
          (若 (等？ ^無 式)
             ...
             (^^式
              ...
              (入 (局態 態 句集乙)
                 (譯始
                  局態-址 局態-境 局態 態-塊集 態 (尾 集)
                  (入 (局態-址 局態-境 局態 態-塊集 態 句集丙 式)
                     (續 局態-址 局態-境 局態 態-塊集 態 (連 句集甲 句集乙 句集丙) 式))))))))))
